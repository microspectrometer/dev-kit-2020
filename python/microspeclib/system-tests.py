...
class TestGetBridgeLED(unittest.TestCase):
    ...
    def test_GetBridgeLED_0_replies_led_setting_2_if_RED(self):
        kit.setBridgeLED(0,RED)
        assert RED == kit.getBridgeLED(0).led_setting
...
class TestSetBridgeLED(unittest.TestCase):
    ...
    def test_SetBridgeLED_1_X_replies_status_ERROR(self):
        # =====[ Operate ]=====
        reply = kit.setBridgeLED(1, GREEN)
...
class TestGetSensorLED(unittest.TestCase):
    ...
    def test_GetSensorLED_0_always_replies_led_setting_is_OFF(self):
        kit.setSensorLED(0,OFF)
        assert OFF == kit.getSensorLED(0).led_setting
        kit.setSensorLED(0,GREEN)
        assert OFF == kit.getSensorLED(0).led_setting
    ...
    def test_GetSensorLED_1_replies_led_setting_0_if_OFF(self):
        ...
        assert OFF == kit.getSensorLED(1).led_setting

    def test_GetSensorLED_1_replies_led_setting_1_if_GREEN(self):
        kit.setSensorLED(1,GREEN)
        assert GREEN == kit.getSensorLED(1).led_setting

    def test_GetSensorLED_1_replies_led_setting_2_if_RED(self):
        kit.setSensorLED(1,RED)
        assert RED == kit.getSensorLED(1).led_setting
...
@unittest.skip # firmware sometimes stores max_exposure incorrectly
...
class TestAutoExposure(unittest.TestCase):
    def tearDown(self):
        kit.setExposure(50)
        # LED 1 is RED if autoexposure fails. Reset LED to GREEN.
        kit.setSensorLED(1, GREEN)
