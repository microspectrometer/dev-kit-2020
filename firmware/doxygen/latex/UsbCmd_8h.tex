...
\item 
void \mbox{\hyperlink{UsbCmd_8h_a2be59832e776d1ef15b9d995e18cf26d}{Get\+Bridge\+LED}} (void)
\item 
void \mbox{\hyperlink{UsbCmd_8h_a5b3a22b24f2d01d4fc902fc7fb7e9de9}{Set\+Bridge\+LED}} (void)
\item 
void \mbox{\hyperlink{UsbCmd_8h_a374617629eb104d96d1b5008aa9af582}{Get\+Sensor\+LED}} (void)
\item 
void \mbox{\hyperlink{UsbCmd_8h_a7e576b6610e3660a10f3768a6cf8ce80}{Set\+Sensor\+LED}} (void)
\item 
...
\item 
\mbox{\Hypertarget{UsbCmd_8h_a4316446918baedd5384d301288ac568c}\label{UsbCmd_8h_a4316446918baedd5384d301288ac568c}} 
void {\bfseries Get\+Sensor\+Hash} (void)
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{UsbCmd_8h_autotoc_md161}{}\doxysubsection{API for usb-\/bridge.\+c}\label{UsbCmd_8h_autotoc_md161}

\begin{DoxyItemize}
\item \mbox{\hyperlink{UsbCmd_8h_ac2b6a4bbe89e22076102bc8a65c69ecd}{Null\+Command()}}
\item \mbox{\hyperlink{UsbCmd_8h_a2be59832e776d1ef15b9d995e18cf26d}{Get\+Bridge\+LED()}}
\item \mbox{\hyperlink{UsbCmd_8h_a5b3a22b24f2d01d4fc902fc7fb7e9de9}{Set\+Bridge\+LED()}}
\item \mbox{\hyperlink{UsbCmd_8h_a374617629eb104d96d1b5008aa9af582}{Get\+Sensor\+LED()}}
\item \mbox{\hyperlink{UsbCmd_8h_a7e576b6610e3660a10f3768a6cf8ce80}{Set\+Sensor\+LED()}}
...
\item waits for sensor to signal STATUS data ready~\newline

\item reads status from sensor~\newline

\item waits for sensor to signal NUM\+\_\+\+PIXELS\+\_\+\+MSB data ready~\newline

\item reads num\+\_\+pixels\+\_\+\+MSB from sensor~\newline

\item waits for sensor to signal NUM\+\_\+\+PIXELS\+\_\+\+LSB data ready~\newline

\item reads num\+\_\+pixels\+\_\+\+LSB from sensor~\newline

\item writes sensor status~\newline

\item writes num\+\_\+pixels\+\_\+\+MSB~\newline

\item writes num\+\_\+pixels\+\_\+\+LSB~\newline
...
Definition at line 514 of file Usb\+Cmd.\+h.

\mbox{\Hypertarget{UsbCmd_8h_a2be59832e776d1ef15b9d995e18cf26d}\label{UsbCmd_8h_a2be59832e776d1ef15b9d995e18cf26d}} 
...
{\footnotesize\ttfamily void Get\+Bridge\+LED (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}

Get\+Bridge\+LED behavior\+:~\newline
...
\item writes two bytes to USB host~\newline

\item writes OK and LED STATE if led num is valid~\newline

\item writes ERROR and pads second byte if led num is invalid~\newline

\end{DoxyItemize}

Definition at line 53 of file Usb\+Cmd.\+h.

\mbox{\Hypertarget{UsbCmd_8h_aeaf4ba863d52c28b92d04846ecaf9586}\label{UsbCmd_8h_aeaf4ba863d52c28b92d04846ecaf9586}} 
...
\item waits for sensor to signal EXPOSURE MSB data ready~\newline

\item reads exposure MSB from sensor~\newline

\item waits for sensor to signal EXPOSURE LSB data ready~\newline

\item reads exposure LSB from sensor~\newline

\item writes sensor status~\newline

\item writes exposure MSB~\newline

\item writes exposure LSB~\newline

\end{DoxyItemize}

Definition at line 422 of file Usb\+Cmd.\+h.

\mbox{\Hypertarget{UsbCmd_8h_a28364aa58a96dc236db7b616e100154e}\label{UsbCmd_8h_a28364aa58a96dc236db7b616e100154e}} 
...
Respond with {\bfseries{five}} bytes\+:
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item If vis-\/spi-\/out {\bfseries{status}} is ERROR, the next three bytes ({\bfseries{binning}}, {\bfseries{gain}}, and {\bfseries{row\+\_\+bitmap}})~\newline
 contain {\itshape garbage} and should be {\bfseries{ignored}} by the host application.~\newline
...
\item proceed reading from sensor if status is OK\+:~\newline

\begin{DoxyItemize}
\item waits for sensor to signal BINNING data ready~\newline

\item reads binning from sensor~\newline

\item waits for sensor to signal GAIN data ready~\newline

\item reads gain from sensor~\newline

\item waits for sensor to signal ROW\+\_\+\+BITMAP data ready~\newline
...
Definition at line 229 of file Usb\+Cmd.\+h.

\mbox{\Hypertarget{UsbCmd_8h_a374617629eb104d96d1b5008aa9af582}\label{UsbCmd_8h_a374617629eb104d96d1b5008aa9af582}} 
...
\item waits for sensor to signal LED SETTING data ready~\newline
...
Definition at line 124 of file Usb\+Cmd.\+h.

\mbox{\Hypertarget{UsbCmd_8h_ac2b6a4bbe89e22076102bc8a65c69ecd}\label{UsbCmd_8h_ac2b6a4bbe89e22076102bc8a65c69ecd}} 
...
Definition at line 50 of file Usb\+Cmd.\+h.

\mbox{\Hypertarget{UsbCmd_8h_ab54bb71cd582d7ce2e3c5a104bf66478}\label{UsbCmd_8h_ab54bb71cd582d7ce2e3c5a104bf66478}} 
...
{\itshape LED 0,} the {\bfseries{status\+\_\+led}}, {\itshape is the only indicator LED on the usb-\/bridge.}

Definition at line 30 of file Usb\+Cmd.\+h.

\mbox{\Hypertarget{UsbCmd_8h_a5b3a22b24f2d01d4fc902fc7fb7e9de9}\label{UsbCmd_8h_a5b3a22b24f2d01d4fc902fc7fb7e9de9}} 
...
{\footnotesize\ttfamily void Set\+Bridge\+LED (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}

Set\+Bridge\+LED behavior\+:~\newline
...
\item writes ERROR if led num is invalid~\newline

\item writes ERROR if led setting is invalid~\newline

\end{DoxyItemize}

Definition at line 82 of file Usb\+Cmd.\+h.

\mbox{\Hypertarget{UsbCmd_8h_a4d2ad66702cccf469e05c42e38033c9b}\label{UsbCmd_8h_a4d2ad66702cccf469e05c42e38033c9b}} 
...
\begin{DoxyItemize}
\item waits for byte exposure\+\_\+\+MSB~\newline

\item reads byte exposure\+\_\+\+MSB~\newline

\item waits for byte exposure\+\_\+\+LSB~\newline

\item reads byte exposure\+\_\+\+LSB~\newline

\item sends command to sensor~\newline

\item sends exposure\+\_\+\+MSB to sensor~\newline

\item sends exposure\+\_\+\+LSB to sensor~\newline
...
Definition at line 466 of file Usb\+Cmd.\+h.

\mbox{\Hypertarget{UsbCmd_8h_ac67c9f0e658e0ea8b47b9b166fb03a83}\label{UsbCmd_8h_ac67c9f0e658e0ea8b47b9b166fb03a83}} 
...
\item vis-\/spi-\/out {\bfseries{status}}
\begin{DoxyItemize}
\item Status is OK if config is loaded.~\newline

\item Status is ERROR if~\newline

\begin{DoxyItemize}
\item the config is invalid~\newline

\item or the {\ttfamily Set\+Sensor\+Config} command is unrecognized\+:~\newline

\begin{DoxyItemize}
\item {\itshape command {\ttfamily Set\+Sensor\+Config} is only defined for spectrometers using the LIS-\/770i}~\newline
...
If the {\ttfamily vis-\/spi-\/out} {\bfseries{status}} is ERROR, there are two possible causes.~\newline
 But {\bfseries{status}} does not include a message, it is either OK or ERROR.~\newline
 The host application should, therefore, tell the user to troubleshoot both possible causes if {\bfseries{status}} is ERROR.~\newline
~\newline
 Tell the user to\+:~\newline

\begin{DoxyEnumerate}
\item Check the connected spectrometer uses the LIS-\/770i\+:~\newline

\begin{DoxyItemize}
\item call get\+Sensor\+Hash()~\newline

\item expect hash is {\ttfamily 0x351ea9}~\newline

\end{DoxyItemize}
\item If the spectrometer {\itshape does} use the LIS-\/770i, check the {\bfseries{config is valid}}\+:~\newline

\begin{DoxyItemize}
\item valid config has {\bfseries{three bytes}}\+:~\newline

\begin{DoxyItemize}
\item \mbox{[}{\ttfamily BINNING}, {\ttfamily GAIN}, {\ttfamily ACTIVE\+\_\+\+ROWS}\mbox{]}~\newline

\end{DoxyItemize}
\item {\ttfamily BINNING} is {\ttfamily 0x00} or {\ttfamily 0x01}~\newline

\item {\ttfamily GAIN} is {\ttfamily 0x01}, {\ttfamily 0x25}, {\ttfamily 0x04}, or {\ttfamily 0x05}~\newline

\item ({\ttfamily ACTIVE\+\_\+\+ROWS} \& {\ttfamily 0x\+E0}) == {\ttfamily 0x00}~\newline

\end{DoxyItemize}
\end{DoxyEnumerate}

In the following description of {\ttfamily Set\+Sensor\+Config} behavior\+:
\begin{DoxyItemize}
\item {\itshape write} and {\itshape read} refer to USB communication with the host application
\item {\itshape send} refers to communication with the sensor
\end{DoxyItemize}
...
\item waits for byte row bitmap~\newline

\item reads byte row bitmap~\newline

\item sends command to sensor~\newline

\item waits for sensor to signal it recognizes the command~\newline

\item proceeds with sending config if sensor status is OK~\newline
...
\item sends row bitmap to sensor~\newline
...
Definition at line 307 of file Usb\+Cmd.\+h.

\mbox{\Hypertarget{UsbCmd_8h_a7e576b6610e3660a10f3768a6cf8ce80}\label{UsbCmd_8h_a7e576b6610e3660a10f3768a6cf8ce80}} 
...
Definition at line 175 of file Usb\+Cmd.\+h.
