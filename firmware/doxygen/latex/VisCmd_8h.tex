...
\hypertarget{VisCmd_8h_autotoc_md35}{}\doxysubsection{API for vis-\/spi-\/out.\+c}\label{VisCmd_8h_autotoc_md35}
...
\end{DoxyItemize}\hypertarget{VisCmd.c_autotoc_md27}{}\doxysubsection{Auto\+Expose uses a \char`\"{}\+Take Back Half\char`\"{} algorithm}\label{VisCmd.c_autotoc_md27}
...
The {\bfseries{large}} tolerance, {\bfseries{±5\%}}, makes the algorithm fast. It usually settles within a few iterations.\hypertarget{VisCmd.c_autotoc_md28}{}\doxysubsubsection{target range}\label{VisCmd.c_autotoc_md28}
...
\end{DoxyItemize}
\end{DoxyItemize}This target range, {\bfseries{\mbox{[} 43143 \+: 49697 \mbox{]}}}, represents 10\% of the full-\/scale reading, {\bfseries{65535}}.\hypertarget{VisCmd.c_autotoc_md29}{}\doxysubsubsection{max\+\_\+dark}\label{VisCmd.c_autotoc_md29}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{VisCmd.c_autotoc_md30}{}\doxysubsection{Algorithm Setup}\label{VisCmd.c_autotoc_md30}
\hypertarget{VisCmd.c_autotoc_md31}{}\doxysubsubsection{Initial state}\label{VisCmd.c_autotoc_md31}
Auto\+Expose is not done\hypertarget{VisCmd.c_autotoc_md32}{}\doxysubsubsection{Method to get peak value}\label{VisCmd.c_autotoc_md32}

\begin{DoxyItemize}
\item expose the LIS-\/770i and readout one frame of data
\item return the peak value in the frame
\end{DoxyItemize}\hypertarget{VisCmd.c_autotoc_md33}{}\doxysubsubsection{Method to clamp exposure time}\label{VisCmd.c_autotoc_md33}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{VisCmd.c_autotoc_md34}{}\doxysubsection{Algorithm}\label{VisCmd.c_autotoc_md34}
...
\hypertarget{VisCmd.c_autotoc_md26}{}\doxysubsection{Algorithm}\label{VisCmd.c_autotoc_md26}
