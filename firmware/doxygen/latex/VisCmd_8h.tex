...
\hypertarget{VisCmd_8h_autotoc_md90}{}\doxysubsection{API for vis-\/spi-\/out.\+c}\label{VisCmd_8h_autotoc_md90}
...
\end{DoxyItemize}\hypertarget{VisCmd.c_autotoc_md82}{}\doxysubsection{Auto\+Expose uses a \char`\"{}\+Take Back Half\char`\"{} algorithm}\label{VisCmd.c_autotoc_md82}
...
The {\bfseries{large}} tolerance, {\bfseries{±5\%}}, makes the algorithm fast. It usually settles within a few iterations.\hypertarget{VisCmd.c_autotoc_md83}{}\doxysubsubsection{target range}\label{VisCmd.c_autotoc_md83}
...
\end{DoxyItemize}
\end{DoxyItemize}This target range, {\bfseries{\mbox{[} 43143 \+: 49697 \mbox{]}}}, represents 10\% of the full-\/scale reading, {\bfseries{65535}}.\hypertarget{VisCmd.c_autotoc_md84}{}\doxysubsubsection{max\+\_\+dark}\label{VisCmd.c_autotoc_md84}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{VisCmd.c_autotoc_md85}{}\doxysubsection{Algorithm Setup}\label{VisCmd.c_autotoc_md85}
\hypertarget{VisCmd.c_autotoc_md86}{}\doxysubsubsection{Initial state}\label{VisCmd.c_autotoc_md86}
Auto\+Expose is not done\hypertarget{VisCmd.c_autotoc_md87}{}\doxysubsubsection{Method to get peak value}\label{VisCmd.c_autotoc_md87}

\begin{DoxyItemize}
\item expose the LIS-\/770i and readout one frame of data
\item return the peak value in the frame
\end{DoxyItemize}\hypertarget{VisCmd.c_autotoc_md88}{}\doxysubsubsection{Method to clamp exposure time}\label{VisCmd.c_autotoc_md88}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{VisCmd.c_autotoc_md89}{}\doxysubsection{Algorithm}\label{VisCmd.c_autotoc_md89}
...
\hypertarget{VisCmd.c_autotoc_md81}{}\doxysubsection{Algorithm}\label{VisCmd.c_autotoc_md81}
