...
\item 
bool \mbox{\hyperlink{VisCmd_8h_accab57292c3f42baef73058c3a94c46c}{Led\+Num\+Is\+Valid}} (\mbox{\hyperlink{BiColorLed_8h_a656bbe981a828f2a0f10cf93d5d2a2dc}{bicolorled\+\_\+num}} led\+\_\+num)
\item 
uint8\+\_\+t \mbox{\hyperlink{VisCmd_8h_a49322dc41b69eb256669262ac54be5e5}{Read\+Led\+State}} (\mbox{\hyperlink{BiColorLed_8h_a656bbe981a828f2a0f10cf93d5d2a2dc}{bicolorled\+\_\+num}} led\+\_\+num)
\item 
...
\item 
void \mbox{\hyperlink{VisCmd_8h_a374617629eb104d96d1b5008aa9af582}{Get\+Sensor\+L\+ED}} (void)
\item 
void \mbox{\hyperlink{VisCmd_8h_a7e576b6610e3660a10f3768a6cf8ce80}{Set\+Sensor\+L\+ED}} (void)
\item 
...
\begin{DoxyCompactList}\small\item\em Allocate static memory for the S\+PI Rx Queue. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{VisCmd_8h_aa0b58e2e3aa5a94e743e302ea7737e82}\label{VisCmd_8h_aa0b58e2e3aa5a94e743e302ea7737e82}} 
uint8\+\_\+t \mbox{\hyperlink{VisCmd_8h_aa0b58e2e3aa5a94e743e302ea7737e82}{frame}} \mbox{[}2 $\ast$\mbox{\hyperlink{Lis_8h_aebccd6b42d427ada3124a7a962e82f39}{M\+A\+X\+\_\+\+N\+U\+M\+\_\+\+P\+I\+X\+E\+LS}}\mbox{]}
...
\doxysubsection*{A\+PI for \mbox{\hyperlink{vis-spi-out_8c}{vis-\/spi-\/out.\+c}}}


\begin{DoxyItemize}
\item \mbox{\hyperlink{VisCmd_8h_ac2b6a4bbe89e22076102bc8a65c69ecd}{Null\+Command()}}
\item \mbox{\hyperlink{VisCmd_8h_a374617629eb104d96d1b5008aa9af582}{Get\+Sensor\+L\+E\+D()}}
\item \mbox{\hyperlink{VisCmd_8h_a7e576b6610e3660a10f3768a6cf8ce80}{Set\+Sensor\+L\+E\+D()}}
...
\item clamps min peak at max dark if target minus tolerance is G\+R\+E\+A\+T\+ER T\+H\+AN target~\newline

\item clamps min peak at max dark if target minus tolerance is L\+E\+SS T\+H\+AN max dark~\newline

\item sets max peak at target plus tolerance~\newline

\item clamps max peak at 65535 counts if target plus tolerance is L\+E\+SS T\+H\+AN target~\newline

\item loops until done~\newline

\item exposes the L\+IS 770i pixels~\newline

\item reads pixel counts into global frame buffer~\newline

\item finds frame peak in range start pixel to stop pixel~\newline

\item is done if peak less than max dark A\+ND exposure at max~\newline

\item scales exposure by 10 if peak less than max dark~\newline

\item clamps exposure at max exposure if 10 x exposure is G\+R\+E\+A\+T\+ER T\+H\+AN max exposure~\newline

\item scales exposure by half if peak A\+B\+O\+VE max peak~\newline

\item clamps exposure at min exposure if half exposure is L\+E\+SS T\+H\+AN min exposure~\newline

\item is done if peak B\+E\+L\+OW min peak and exposure at max exposure~\newline

\item scales exposure by target div peak if peak B\+E\+L\+OW min peak and exposure not at max~\newline

\item clamps exposure at max exposure if gain is G\+R\+E\+A\+T\+ER T\+H\+AN max exposure~\newline
...
\doxysubsection*{Auto\+Expose uses a \char`\"{}\+Take Back Half\char`\"{} algorithm}
...
\begin{DoxyItemize}
\item multiply exposure by {\ttfamily target} {\itshape B\+E\+F\+O\+RE} dividing by {\ttfamily peak}\+:
\begin{DoxyItemize}
...
The {\bfseries{large}} tolerance, {\bfseries{±5\%}}, makes the algorithm fast. It usually settles within a few iterations.

\doxysubsubsection*{target range }
...
\end{DoxyItemize}{\bfseries{49697}} counts is the {\itshape top} of the guaranteed {\bfseries{linear}} range of output values for the L\+I\+S-\/770i
\begin{DoxyItemize}
\item this value is based on the dev-\/kit design\+:
\begin{DoxyItemize}
\item {\bfseries{16-\/bit}} A\+DC
\item {\bfseries{1.\+8V}} A\+DC voltage reference
\item L\+I\+S-\/770i power supply\+: {\bfseries{3.\+3V}}
\end{DoxyItemize}
\item and based on the L\+I\+S-\/770i programming configuration\+:
\begin{DoxyItemize}
\item binning {\bfseries{on}}
\item gain {\bfseries{1x}}
\item {\bfseries{all rows}} active
\end{DoxyItemize}
\end{DoxyItemize}This target range, {\bfseries{\mbox{[} 43143 \+: 49697 \mbox{]}}}, represents 10\% of the full-\/scale reading, {\bfseries{65535}}.

\doxysubsubsection*{max\+\_\+dark }
...
\begin{DoxyItemize}
\item trims the output offset voltage of the L\+I\+S-\/770i
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}

\doxysubsection*{Algorithm Setup}

\doxysubsubsection*{Initial state }

Auto\+Expose is not done

\doxysubsubsection*{Method to get peak value }


\begin{DoxyItemize}
\item expose the L\+I\+S-\/770i and readout one frame of data
\item return the peak value in the frame
\end{DoxyItemize}\doxysubsubsection*{Method to clamp exposure time }
...
\doxysubsection*{Algorithm}

while {\bfseries{Auto\+Expose is not done}}\+:
\begin{DoxyItemize}
\item expose L\+I\+S-\/770i
\item readout L\+I\+S-\/770i, store in global {\ttfamily frame} buffer
...
\end{DoxyItemize}
\end{DoxyItemize}
\item elif {\ttfamily peak} is A\+B\+O\+VE target range\+: {\ttfamily // peak is $>$ max\+\_\+peak}
\begin{DoxyItemize}
\item {\bfseries{T\+A\+KE B\+A\+CK H\+A\+LF}} {\ttfamily // exposure time = 1/2 exposure time}
\end{DoxyItemize}
\item elif {\ttfamily peak} is B\+E\+L\+OW target range\+: {\ttfamily // peak is $<$ min\+\_\+peak}
\begin{DoxyItemize}
\item if at max exposure time\+:
\begin{DoxyItemize}
\item {\bfseries{Auto\+Expose is done}}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_ae68a7e94e1584ce65d3ef0d22f432f57}\label{VisCmd_8h_ae68a7e94e1584ce65d3ef0d22f432f57}} 
...
\item sends num pixels M\+SB~\newline

\item sends num pixels L\+SB~\newline
...
\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_aeaf4ba863d52c28b92d04846ecaf9586}\label{VisCmd_8h_aeaf4ba863d52c28b92d04846ecaf9586}} 
...
\item sends M\+SB of exposure ticks~\newline

\item sends L\+SB of exposure ticks~\newline

\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_aaa49202fc0999c3a3f06da7787f30565}\label{VisCmd_8h_aaa49202fc0999c3a3f06da7787f30565}} 
...
{\footnotesize\ttfamily uint16\+\_\+t Get\+Peak (\begin{DoxyParamCaption}\item[{uint16\+\_\+t const}]{,  }\item[{uint16\+\_\+t const}]{ }\end{DoxyParamCaption})}
...
byte\+\_\+index example\+: v-\/-\/-\/-\/--- if \+\_\+start\+\_\+pixel is 7 pixel\+: 1 2 3 4 5 6 7 8 byte\+: 01 23 45 67 89 AB CD EF $^\wedge$-\/-\/-\/-\/--- then byte\+\_\+index is 12\mbox{\Hypertarget{VisCmd_8h_a28364aa58a96dc236db7b616e100154e}\label{VisCmd_8h_a28364aa58a96dc236db7b616e100154e}} 
...
\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_a374617629eb104d96d1b5008aa9af582}\label{VisCmd_8h_a374617629eb104d96d1b5008aa9af582}} 
...
\item sends OK and L\+ED S\+E\+T\+T\+I\+NG if led num is valid~\newline

\item sends E\+R\+R\+OR and pads second byte if led num is invalid~\newline

\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_accab57292c3f42baef73058c3a94c46c}\label{VisCmd_8h_accab57292c3f42baef73058c3a94c46c}} 
...
{\footnotesize\ttfamily bool Led\+Num\+Is\+Valid (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{BiColorLed_8h_a656bbe981a828f2a0f10cf93d5d2a2dc}{bicolorled\+\_\+num}}}]{led\+\_\+num }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}

Led\+Num\+Is\+Valid behavior\+:~\newline

\begin{DoxyItemize}
\item returns T\+R\+UE if led num is 0~\newline

\item returns T\+R\+UE if led num is 1~\newline

\item returns F\+A\+L\+SE if led num is not 0 or 1~\newline

\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_aada5013dffe7417b0ed6754fabe7464f}\label{VisCmd_8h_aada5013dffe7417b0ed6754fabe7464f}} 
...
\begin{DoxyItemize}
\item waits for Lis\+\_\+\+Sync to go H\+I\+GH then go L\+OW~\newline

\item reads one pixel on each rising edge of Lis\+\_\+\+Clk~\newline

\item L\+O\+OP\+: wait for the rising edge of Lis\+\_\+\+Clk~\newline

\item L\+O\+OP\+: start the A\+DC conversion~\newline

\item L\+O\+OP\+: wait for 45 cycles of 10M\+Hz clock~\newline

\item L\+O\+OP\+: start A\+DC readout~\newline

\item L\+O\+OP\+: wait for most significant byte of A\+DC readout~\newline

\item L\+O\+OP\+: save M\+SB to frame buffer~\newline

\item L\+O\+OP\+: wait for least significant byte of A\+DC readout~\newline

\item L\+O\+OP\+: save L\+SB to frame buffer~\newline

\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_ac2b6a4bbe89e22076102bc8a65c69ecd}\label{VisCmd_8h_ac2b6a4bbe89e22076102bc8a65c69ecd}} 
...
Do nothing.\mbox{\Hypertarget{VisCmd_8h_a49322dc41b69eb256669262ac54be5e5}\label{VisCmd_8h_a49322dc41b69eb256669262ac54be5e5}} 
...
{\footnotesize\ttfamily uint8\+\_\+t Read\+Led\+State (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{BiColorLed_8h_a656bbe981a828f2a0f10cf93d5d2a2dc}{bicolorled\+\_\+num}}}]{led\+\_\+num }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_a223d486351108244d6138b2c74196a99}\label{VisCmd_8h_a223d486351108244d6138b2c74196a99}} 
...
\begin{DoxyItemize}
\item transmits one byte over S\+PI~\newline

\item sends byte I\+N\+V\+A\+L\+ID C\+MD~\newline

\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_a4d2ad66702cccf469e05c42e38033c9b}\label{VisCmd_8h_a4d2ad66702cccf469e05c42e38033c9b}} 
...
\begin{DoxyItemize}
\item waits for byte exposure M\+SB~\newline

\item reads byte exposure M\+SB~\newline

\item waits for byte exposure L\+SB~\newline

\item reads byte exposure L\+SB~\newline

\item updates global exposure ticks~\newline

\item sends OK~\newline

\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_ac67c9f0e658e0ea8b47b9b166fb03a83}\label{VisCmd_8h_ac67c9f0e658e0ea8b47b9b166fb03a83}} 
...
\item replies E\+R\+R\+OR if binning is invalid~\newline

\item replies E\+R\+R\+OR if gain is invalid~\newline

\item replies E\+R\+R\+OR if active rows is invalid~\newline

\item does not program L\+IS 770i if config is invalid~\newline

\item writes valid config to L\+IS 770i programmable setup register~\newline

\item replies OK if all config values are valid~\newline

\item the OK is sent after L\+IS is programmed with new config~\newline

\end{DoxyItemize}\mbox{\Hypertarget{VisCmd_8h_a7e576b6610e3660a10f3768a6cf8ce80}\label{VisCmd_8h_a7e576b6610e3660a10f3768a6cf8ce80}} 
...
\item sends E\+R\+R\+OR if led num is invalid~\newline

\item sends E\+R\+R\+OR if led setting is invalid~\newline

\item applies L\+ED setting if valid~\newline
