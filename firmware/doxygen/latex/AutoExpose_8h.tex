...
\hypertarget{AutoExpose_8h_autotoc_md77}{}\doxysubsection{Global Auto\+Expose config}\label{AutoExpose_8h_autotoc_md77}
\hypertarget{AutoExpose_8h_autotoc_md78}{}\doxysubsubsection{Auto\+Expose maximum number of tries}\label{AutoExpose_8h_autotoc_md78}
Auto\+Expose gives up if it cannot hit the target peak counts range after {\ttfamily max\+\_\+tries} attempts. Recommended value is {\bfseries{10}}. Use smaller numbers to speed up Auto\+Expose. Set the value to {\bfseries{1}} to manually trigger each iteration and get a sense of how many tries are necessary to hit the target range. The range of allowed values is 1 to 255.\hypertarget{AutoExpose_8h_autotoc_md79}{}\doxysubsubsection{Auto\+Expose pixel range}\label{AutoExpose_8h_autotoc_md79}
...
With binning on, the default pixel range is also the allowed range of values. Attempting to exceed this range, it is clamped at these boundaries. With binning off, the allowed range is {\ttfamily start\+\_\+pixel = 14}, {\ttfamily stop\+\_\+pixel = 784}.\hypertarget{AutoExpose_8h_autotoc_md80}{}\doxysubsubsection{Auto\+Expose target peak counts range}\label{AutoExpose_8h_autotoc_md80}
