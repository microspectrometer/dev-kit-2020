...
Pasting the disassembly into the code helped me check that the compiler was still using the right instructions after a code change. This is how I determined the correct steps to make {\ttfamily inline} actually inline the code.\hypertarget{index_autotoc_md11}{}\doxysubsection{Conventional C yields inefficient assembly}\label{index_autotoc_md11}
{\itshape The simplest example is the bit manipulation functions discussed below. The same reasoning applies to all the {\ttfamily lib} code.}
