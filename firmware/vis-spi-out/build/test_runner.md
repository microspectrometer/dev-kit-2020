...
`put_config_in_Queue`...
Invalid config value in this test: gain 
...
`put_config_in_Queue`...
Invalid config value in this test: active_rows
...
- Value passed to call 2, arg 1? 
    - (uint8_t)0x35 is arg 1 to call SpiSlaveTxByte.
...
- Value passed to call 3, arg 1? 
    - (uint8_t)0x1e is arg 1 to call SpiSlaveTxByte.


- Call 4 is named SpiSlaveTxByte? Yes.
